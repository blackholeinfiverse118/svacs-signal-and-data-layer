...
SCENARIOS = [
    {
        ...
        "description": "Stable low-frequency cargo ship signal (50-200 Hz). Steady amplitude, minimal noise.",
        "pipeline_notes": {"detection": "strong", "classification": "cargo_ship",
    ...
    },
    {
        ...
        "description": "High-frequency speedboat signal (500-1500 Hz). Irregular waveform with 2nd harmonic.",
        "pipeline_notes": {"detection": "strong", "classification": "speedboat",
    ...
    },
    {
        ...
        "description": "Very low frequency submarine signal (20-100 Hz). Low energy, partially masked.",
        "pipeline_notes": {"detection": "weak", "classification": "submarine",
    ...
    },
    {
        ...
        "description": "Weak signal buried under heavy ocean noise. Simulates distant vessel or degraded sensor.",
        "pipeline_notes": {"detection": "uncertain", "classification": "unknown",
    ...
    },
    {
        ...
        "description": "Multi-frequency spike pattern with random amplitude bursts. Does NOT match any known vessel profile.",
        "pipeline_notes": {"detection": "triggered", "classification": "anomaly",
...
class ScenarioBuilder:
    ...
    def _write_index(self):
        index = [{"id": s["id"], "name": s["name"], "file": s["filename"],
